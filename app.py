...
with st.sidebar:
    ...
    col_costo = "Precio Fabrica" # Siempre fijo para cálculo de utilidad
    
    st.caption(f"Calculando precios sobre: **{col_venta}**")
...
with col_sel:
    ...
    # Precios dinámicos según columnas
...
if len(st.session_state['carrito']) > 0:
    ...
    # Mostrar tabla completa (incluyendo columnas ocultas de dinero para ti)
    ...
    # Botón de Correo (Solo envía datos de venta al cliente, no costos)
